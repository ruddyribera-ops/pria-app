...
import { buildSlideDeck } from '../../lib/pptx/buildSlides';
...
export default function SlideEditorPanel({
  mergedData, typeLabel, filenameExtra, motorType = 'slides', onClear,
  ...
  const handleDownload = useCallback(async () => {
    ...
    try {
      ...
      const blob = await buildSlideDeck(finalData as any, subject);
      ...
      <div style={{
        ...
        {isSlides && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
            <button onClick={zoomOut} title="Alejar" style={{
            ...
            <button onClick={zoomIn} title="Acercar" style={{
              padding: '0.25rem 0.5rem', border: '1px solid #d4d4e0',
              borderRadius: '4px', background: '#fff', fontSize: '0.75rem',
              cursor: 'pointer', color: '#6b6b80',
            }}>+</button>
