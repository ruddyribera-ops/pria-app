...
| **Sprint 12** | ✅ DONE | 2026-05-29 | 2026-05-30 | External Agent | Prompts & Data: backend prompt API, prompt versioning (git SHA), history output endpoint, CSRF protection, complete .env.example |
